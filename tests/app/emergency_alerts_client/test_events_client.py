from app.emergency_alerts_client.events_api_client import EventsApiClient
...
def test_events_client_calls_correct_api_endpoint(mocker):
    ...
    mock_post = mocker.patch("app.emergency_alerts_client.events_api_client.EventsApiClient.post")
