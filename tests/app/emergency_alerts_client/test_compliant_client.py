from app.emergency_alerts_client.complaint_api_client import ComplaintApiClient


def test_get_all_complaints(mocker):
    client = ComplaintApiClient()

    mock = mocker.patch("app.emergency_alerts_client.complaint_api_client.ComplaintApiClient.get")
