...
from app.emergency_alerts_client.notification_api_client import NotificationApiClient
...
def test_client_gets_notifications_for_service_and_job_by_page(mocker, arguments, expected_call):
    mock_get = mocker.patch("app.emergency_alerts_client.notification_api_client.NotificationApiClient.get")
...
def test_client_gets_notifications_for_service_and_job_by_page_posts_for_to(mocker, arguments, expected_call):
    mock_post = mocker.patch("app.emergency_alerts_client.notification_api_client.NotificationApiClient.post")
    NotificationApiClient().get_notifications_for_service("abcd1234", **arguments)
...
def test_get_api_notifications_changes_letter_statuses(mocker, letter_status, expected_status):
    ...
    mocker.patch("app.emergency_alerts_client.notification_api_client.NotificationApiClient.get", return_value=notis)
