...
def test_create_broadcast_message(mocker):
    ...
    mock_post = mocker.patch("app.emergency_alerts_client.broadcast_message_api_client.BroadcastMessageAPIClient.post")
...
def test_get_broadcast_messages(mocker):
    client = BroadcastMessageAPIClient()
    mock_get = mocker.patch("app.emergency_alerts_client.broadcast_message_api_client.BroadcastMessageAPIClient.get")
...
def test_get_broadcast_message(mocker):
    ...
    mock_get = mocker.patch(
        "app.emergency_alerts_client.broadcast_message_api_client.BroadcastMessageAPIClient.get",
