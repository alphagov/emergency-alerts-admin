...
from app.emergency_alerts_client.email_branding_client import EmailBrandingClient


def test_get_email_branding(mocker, fake_uuid):
    mock_get = mocker.patch(
        "app.emergency_alerts_client.email_branding_client.EmailBrandingClient.get", return_value={"foo": "bar"}
    )
...
def test_get_all_email_branding(mocker):
    mock_get = mocker.patch(
        "app.emergency_alerts_client.email_branding_client.EmailBrandingClient.get",
...
def test_create_email_branding(mocker, fake_uuid):
    ...
    mock_post = mocker.patch("app.emergency_alerts_client.email_branding_client.EmailBrandingClient.post")
...
def test_get_email_branding_name_for_alt_text(mocker):
    mock_post = mocker.patch(
        "app.emergency_alerts_client.email_branding_client.EmailBrandingClient.post", return_value={"name": "bar"}
    )
