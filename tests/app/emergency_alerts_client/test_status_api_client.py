from app.emergency_alerts_client.status_api_client import StatusApiClient
...
def test_sets_value_in_cache(mocker):
    ...
    mock_api_get.assert_called_once_with(url="/_api_status/live-service-and-organisation-counts")
