...
from app.emergency_alerts_client.service_api_client import ServiceAPIClient
...
def test_client_posts_archived_true_when_deleting_template(mocker):
    ...
    mock_post = mocker.patch("app.emergency_alerts_client.service_api_client.ServiceAPIClient.post")
    mocker.patch(
        "app.emergency_alerts_client.service_api_client.ServiceAPIClient.get",
...
def test_client_creates_service_with_correct_data(
    ...
    mocker.patch("app.emergency_alerts_client.current_user", id="123")
...
def test_client_doesnt_delete_service_template_cache_when_none_exist(
    emergency_alerts_admin, mock_get_user, mock_get_service_templates_when_no_templates_exist, mocker
):
    mocker.patch("app.emergency_alerts_client.current_user", id="1")
...
def test_client_deletes_service_template_cache_when_service_is_updated(emergency_alerts_admin, mock_get_user, mocker):
    mocker.patch("app.emergency_alerts_client.current_user", id="1")
    mocker.patch("notifications_python_client.base.BaseAPIClient.request")
    mock_redis_delete = mocker.patch("app.extensions.RedisClient.delete")
    mock_redis_delete_by_pattern = mocker.patch("app.extensions.RedisClient.delete_by_pattern")
