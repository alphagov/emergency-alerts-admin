...
from app.emergency_alerts_client.billing_api_client import BillingAPIClient
...
def test_get_free_sms_fragment_limit_for_year_correct_endpoint(mocker, api_user_active):
    ...
    mock_get = mocker.patch("app.emergency_alerts_client.billing_api_client.BillingAPIClient.get")
...
def test_post_free_sms_fragment_limit_for_current_year_endpoint(mocker, api_user_active):
    ...
    mock_post = mocker.patch("app.emergency_alerts_client.billing_api_client.BillingAPIClient.post")
    client = BillingAPIClient()
