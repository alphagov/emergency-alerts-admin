...
def test_create_template_folder_calls_correct_api_endpoint(mocker, parent_id):
    ...
    mock_post = mocker.patch("app.emergency_alerts_client.template_folder_api_client.TemplateFolderAPIClient.post")
...
def test_get_template_folders_calls_correct_api_endpoint(mocker):
    ...
    mock_api_get = mocker.patch(
        "app.emergency_alerts_client.EmergencyAlertsAdminAPIClient.get", return_value={"template_folders": {"a": "b"}}
    )
...
def test_move_templates_and_folders(mocker):
    mock_redis_delete = mocker.patch("app.extensions.RedisClient.delete")
    mock_api_post = mocker.patch("app.emergency_alerts_client.EmergencyAlertsAdminAPIClient.post")
...
def test_delete_template_folder_calls_correct_api_endpoint(mocker):
    ...
    mock_delete = mocker.patch("app.emergency_alerts_client.template_folder_api_client.TemplateFolderAPIClient.delete")
