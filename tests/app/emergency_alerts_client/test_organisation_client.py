...
def test_update_organisation_when_not_updating_org_type(
    ...
    mock_redis_delete = mocker.patch("app.extensions.RedisClient.delete")
    mock_post = mocker.patch("app.emergency_alerts_client.organisations_api_client.OrganisationsClient.post")
...
def test_remove_user_from_organisation_deletes_user_cache(mocker):
    mock_redis_delete = mocker.patch("app.extensions.RedisClient.delete")
    mock_delete = mocker.patch("app.emergency_alerts_client.organisations_api_client.OrganisationsClient.delete")
...
def test_get_letter_branding_pool(mocker):
    ...
    mock_get = mocker.patch(
        "app.emergency_alerts_client.organisations_api_client.OrganisationsClient.get",
