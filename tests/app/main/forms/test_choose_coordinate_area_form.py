...
@pytest.mark.parametrize(
    ...
    (
        (
            ["", "", 2],
            {"first_coordinate": ["Enter a value."], "second_coordinate": ["Enter a value."]},
        ),
        (
            [91, 181, 2],
            {
...
@pytest.mark.parametrize(
    ...
    (
        ...
        (
            [-1, -1, 2],
            {
                "first_coordinate": ["Enter an Easting between 0 and 500,000."],
                "second_coordinate": ["Enter a Northing greater than 0."],
            },
        ),
        (
            [500001, 2, 2],
