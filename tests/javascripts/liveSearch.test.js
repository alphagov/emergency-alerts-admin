...
describe('Live search', () => {
  ...
  describe("With a list of radios", () => {
    ...
    beforeEach(() => {
      ...
      document.body.innerHTML = `
        <div class="live-search js-header" data-emergency-alerts-module="live-search" data-targets=".govuk-radios__item">
  ...
  describe("With a list of checkboxes", () => {
    ...
    beforeEach(() => {
      ...
      // set up DOM
      document.body.innerHTML = `
        <div class="live-search js-header" data-emergency-alerts-module="live-search" data-targets="#template-list .template-list-item">
  ...
  describe("With a list of content items", () => {
    ...
    beforeEach(() => {
      ...
      // set up DOM
      document.body.innerHTML = `
        <div class="live-search js-header" data-emergency-alerts-module="live-search" data-targets=".user-list-item">
          <div class="form-group" data-emergency-alerts-module="">
            <label class="form-label" for="search">
                ${searchLabelText}
            </label>
            <input autocomplete="off" class="form-control form-control-1-1 " data-emergency-alerts-module="" id="search" name="search" rows="8" type="search" value="">
            <div role="region" aria-live="polite" class="live-search__status govuk-visually-hidden"></div>
          </div>
        </div>
        <form method="post" autocomplete="off" novalidate>
