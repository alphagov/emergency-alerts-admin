      ...
      <form method="post" autocomplete="off" novalidate="">
        <div class="govuk-form-group">
          <fieldset class="govuk-fieldset" id="banner">
            ...
            <div class="govuk-radios emergency-alerts-radios-with-images govuk-radios--inline">
              <div class="govuk-radios__item emergency-alerts-radios-with-images__item">
                <img src="/static/images/branding/org.png?4da479dbe00edb51dfac2f38fed58ea2"
                     ...
                     width="404" height="454" id="banner-0-description" class="emergency-alerts-radios-with-images__image"
                     data-emergency-alerts-module="radios-with-images">
                <div class="emergency-alerts-radios-with-images__radio">
              ...
              <div class="govuk-radios__item emergency-alerts-radios-with-images__item">
                <img src="/static/images/branding/org_banner.png?cb13c90781ffbe6f4f3d8e6fab1d2b8b"
                     ...
                     width="404" height="454" id="banner-1-description" class="emergency-alerts-radios-with-images__image"
                     data-emergency-alerts-module="radios-with-images">
                <div class="emergency-alerts-radios-with-images__radio">
