  ...
  beforeEach(() => {
    ...
    cookiesPageContent = `
      <div class="cookie-settings__confirmation banner banner-with-tick" data-cookie-confirmation="true" role="group" tabindex="-1">
        ...
        <a class="govuk_link govuk_link--no-visited-state cookie-settings__prev-page" href="#" data-emergency-alerts-module="track-click" data-track-category="cookieSettings" data-track-action="Back to previous page">
      ...
      <div class="cookie-settings__form-wrapper">
        <form data-emergency-alerts-module="cookie-settings">
