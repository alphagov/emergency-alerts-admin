...
describe("TemplateFolderForm", () => {
  ...
  beforeEach(() => {
    ...
    templateFolderForm = document.querySelector(
      "form[data-notify-module=template-folder-form]"
    );
  });
  ...
  describe("When the module starts", () => {
    ...
    test("the 'New folder' button should not have an aria-expanded attribute", () => {
      setFixtures(hierarchy, "data-channel='broadcast' data-service='123'");
  ...
  describe("Click 'New template' for single channel service", () => {
    test("should redirect to new template page", () => {
      ...
      expect(mockCallback).toHaveBeenCalledWith(
        "/services/123/templates/choose-template-fields"
      );
  ...
  describe("Clicking 'New template'", () => {
    beforeEach(() => {
      ...
      window.location = {
        pathname: "/services/123/templates",
      };
