...
describe('Update content', () => {
  ...
  const getInitialHTMLString = partial => `
    <div data-emergency-alerts-module="update-content" data-resource="${resourceURL}" data-key="${updateKey}">
      ${partial}
    </div>`;
  ...
  describe("All variations", () => {
    ...
    beforeEach(() => {
      ...
      // default the response to match the content inside div[data-emergency-alerts-module]
    ...
    describe("By default", () => {
      ...
      each([
        ...
        [24000, 10000],
          ...
          expect(
            window.GOVUK.EmergencyAlertsModules.UpdateContent.calculateBackoff(responseTime)
          ).toBe(
            waitTime
          );
      });
    ...
    describe("If a form is used as a source for data, referenced in the data-form attribute", () => {
      ...
      beforeEach(() => {
        ...
        document.querySelector('[data-emergency-alerts-module=update-content]').setAttribute('data-form', 'service');
