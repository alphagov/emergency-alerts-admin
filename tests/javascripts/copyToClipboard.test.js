...
describe('copy to clipboard', () => {
  ...
  const setUpDOM = function (options) {
    ...
    document.body.innerHTML =`
      ...
      <div data-emergency-alerts-module="copy-to-clipboard" data-value="${apiKey}" data-thing="${options.thing}" data-name="${options.name}">
  ...
  test("If copy command isn't available, nothing should happen", () => {
    ...
    component = document.querySelector('[data-emergency-alerts-module=copy-to-clipboard]');
    ...
    describe("On page load", () => {
      ...
      describe("For all variations of the initial HTML", () => {
        ...
        beforeEach(() => {
          ...
          stylesheet.innerHTML = '[data-emergency-alerts-module=copy-to-clipboard] { height: auto; }'; // set to browser default
